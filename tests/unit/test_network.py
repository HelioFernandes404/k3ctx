...
class TestIsPrivateNetwork:
    ...
    def test_rejects_public_ips(self) -> None:
...
class TestCheckNetworkRequirement:
    ...
    def test_detects_sshuttle_for_private_ip(self) -> None:
    ...
    def test_returns_none_for_public_ip(self) -> None:
    ...
    def test_returns_none_when_ansible_host_missing(self) -> None:
    ...
    def test_calculates_correct_network_range(self) -> None:
