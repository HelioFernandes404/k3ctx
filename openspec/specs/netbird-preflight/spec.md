...
Define how `k3ctx` validates NetBird daemon and peer readiness before attempting any SSH connection, ensuring authenticated overlay-network access is available.
