...
Provides a `tunnel-reconnect` command that re-establishes a broken SSH tunnel for a named context using persisted connection parameters, without repeating inventory lookup or kubeconfig merge.
