...
Provides `k3ctx telemetry tail` and `k3ctx telemetry stats` subcommands for inspecting recorded telemetry events — browsing recent events and viewing per-command aggregates.
