...
- **THEN** the system outputs a JSON-safe connect result containing success, context name, ports, tunnel PID, cache usage, network requirement, error, and ArgoCD local port fields
